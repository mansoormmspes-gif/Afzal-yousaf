        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
            <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    ...
                    <p style={{ color: 'yellow', marginTop: '0.5rem' }}>Update static text across the website.</p>
                </div>
                <Link href="/admin/dashboard" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'yellow', textDecoration: 'none' }}>
